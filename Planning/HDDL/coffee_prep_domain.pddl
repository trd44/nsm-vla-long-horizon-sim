(define (domain coffee-prep)
	...
	(:action reach
        ...
        :precondition (and (on ?obj ?table) (free ?gripper))
    ...
    (:action flip-up
        :parameters (?obj - opennable ?gripper - gripper)
    ...
    (:action flip-down
        :parameters (?obj - opennable ?gripper - gripper)
        :precondition (and (flipped-up ?obj) (free ?gripper))
        :effect (flipped-down ?obj)
    )
	...
	(:method open-dispenser-method
		:parameters (?dispenser - coffee-dispenser ?lid - coffee-dispenser-lid ?gripper - gripper)
		:task (open-dispenser-task ?dispenser ?lid ?gripper)
		:subtasks (
			(reach ?lid ?gripper)
			(flip-up ?lid ?gripper)
		)
